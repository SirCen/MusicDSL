package uk.ac.rhul.cs.csle.art.generator;

import uk.ac.rhul.cs.csle.art.util.text.ARTText;
import uk.ac.rhul.cs.csle.art.v3.manager.ARTDirectiveBlock;
...
public class ARTOSBRDGenerator {
  ...
  ARTDirectiveBlock optionBlock;

  public ARTOSBRDGenerator(ARTGrammar artGrammar, ARTDirectiveBlock optionBlock) {
  ...
  public void generateParser(ARTText artText) {
    artText.println("import java.io.FileNotFoundException;\n\nclass ARTGeneratedParser extends uk.ac.rhul.cs.csle.art.generator.ARTOSBRDBase {\n");
