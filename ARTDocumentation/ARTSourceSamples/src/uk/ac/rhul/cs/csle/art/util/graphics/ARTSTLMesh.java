...
public class ARTSTLMesh extends TriangleMesh {
  ...
  public ARTSTLMesh(ARTSTLParser stlParser, float offsetX, float offsetY, float offsetZ, float scale) throws ARTException {
    this(stlParser, false, offsetX, offsetY, offsetZ, scale);
  }

  public ARTSTLMesh(ARTSTLParser stlParser, Boolean flipZ, float offsetX, float offsetY, float offsetZ, float scale) throws ARTException {
    super();
